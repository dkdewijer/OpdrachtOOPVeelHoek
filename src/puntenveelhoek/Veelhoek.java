...
public class Veelhoek {
    ...
    private static final int MINIMAAL_AANTAL_PUNTEN = 3; //Hier haal ik the magic number weg
     ...
     *
     * @param naam
     * @param aantalPunten Als het aantal punten dat de gebruiker opgeeft groter
     * of gelijk is aan 3 gaat het door een for loop waarbij
     */
    public Veelhoek(String naam, int aantalPunten) {
        this.naam = naam;
        if (aantalPunten >= MINIMAAL_AANTAL_PUNTEN) {
    ...
    /**
     * een method die de coördinaten veranderd en uitprint als het punt dat
     * ingevoerd wordt niet bestaat
     *
     * @param index
     * @param p
     */
